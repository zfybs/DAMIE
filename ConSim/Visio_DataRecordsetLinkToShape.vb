...
''' </summary>
''' <remarks></remarks>
Public Class DataRecordsetLinkToShape
...
#End Region
    ...
    Private Function ValidateShapes(ByVal page As Visio.Page, ByVal DRS As Visio.DataRecordset, ByVal intIndexOfShapeID As Integer) As Boolean
        ...
        If DRS IsNot Nothing Then
            ...
            For Each id As Integer In lngRowIDs
                ...
                Catch ex As Exception
                    blnValidated = False
                    Dim Result = MessageBox.Show("在页面中没有找到与形状ID """ & shapeID & """ 相匹配的形状。请仔细检查记录的形状ID值。",
    ...
    ''' <remarks></remarks>
    Private Function PassDataRecordsetToShape(ByVal DataRS As Visio.DataRecordset, ByVal Page As Visio.Page,
                                         Optional ByVal ColumnIndex_PrimaryKey As Short = 0,

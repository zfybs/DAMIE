...
Partial Class frmDeriveData
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmDeriveData))
        ...
        Me.Name = "frmDeriveData"
        Me.Text = "从Excel或Word中提取数据"
    ...
    End Sub
    Protected WithEvents btnExport As System.Windows.Forms.Button
    ...
    Protected WithEvents MyDataGridView1 As DAMIE.AME_UserControl.myDataGridView
    Private WithEvents btn_DateFormat As System.Windows.Forms.Button
    Private WithEvents BtnChoosePath As System.Windows.Forms.Button
    Protected WithEvents ListBoxDocuments As System.Windows.Forms.ListBox
